    ...
    if (data.swimmer.age < 19) {
        if (data.swimmer.age > 9) {
            html.push(`<th colspan="${stdName.length}" class="smt">`,
                createPopup('Single Age Motivational Standards', 'USA Swimming 2024-2028 Single Age Motivational Standards'),
                '</th>');
        }
        html.push(`<th colspan="${stdName.length}" class="mt">`,
            createPopup('Age-Group Motivational Standards', 'USA Swimming 2024-2028 Age-Group Motivational Standards'),
            '</th>');
    }
